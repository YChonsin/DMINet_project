# run DMI-Net training using the following command (you can modify the parameters yourself)
...
python ./src/reconstruction_train.py --net DMINet128 --epochs 50 --gpunum 1 --lr 0.0001 --dpath recon128 --batchSize 8
